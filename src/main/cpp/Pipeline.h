...
//
//struct Standard{
//    std::vector<std::vector<float>> prelude;
//    std::vector<std::vector<float>> backward_extension;
//    std::vector<std::vector<float>> bow_stance;
...
public:
  ...
  void ClearCount();
  std::vector<int> GetCountAndScore();
private:
