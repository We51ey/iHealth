...
public class PoseButton extends ConstraintLayout {
    ...
    public PoseButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        pbTextView=findViewById(R.id.pb_tip);
...
//        String pbTipId=typedArray.getString(R.styleable.pose_button_pose_tips);
//        setPoseTip(pbTipId);
    }
    ...
    public void setPoseTip(String pbTip){
        pbTextView.setText(pbTip);
    }
}
